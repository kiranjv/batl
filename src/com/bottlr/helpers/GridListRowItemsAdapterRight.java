...
public class GridListRowItemsAdapterRight extends BaseAdapter {
	...
	static private final Logger logger = LoggerFactory
			.getLogger(GridListRowItemsAdapterRight.class);

	public GridListRowItemsAdapterRight(Context context, ArrayList<BottleDetails> results) {
