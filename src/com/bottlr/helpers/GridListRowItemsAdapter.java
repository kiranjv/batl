...
import com.bottlr.imgloader.ImageLoaderOriginal;
import com.bottlr.utils.TAGS;
import com.bottlr.utils.Utils;
import com.bottlr.views.HomeScreenView;

public class GridListRowItemsAdapter extends BaseAdapter {

	private final String TAG = "ListRowItemsAdapter";
	private LayoutInflater l_Inflater;
	private Context context;
	private ArrayList<BottleDetails> itemDetailsrrayList;
	private int ALLOWED_ROWS = 0;
	private ImageLoader imageLoader;
	private ImageLoaderOriginal orgimageLoader;
	private final Logger logger = LoggerFactory
			.getLogger(GridListRowItemsAdapter.class);
	

	public GridListRowItemsAdapter(Context context, ArrayList<BottleDetails> results) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View row = l_Inflater.inflate(R.layout.new_single_bottle_layout, null);
	...
	private void updateRowItemLayout(View row, BottleDetails bottle) {
		...
		if (orgimageLoader == null) {
			orgimageLoader = new ImageLoaderOriginal(context);
		}
		orgimageLoader.DisplayImage(bottle.getAvatar_img(), profileImg);
