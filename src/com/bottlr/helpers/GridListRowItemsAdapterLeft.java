...
public class GridListRowItemsAdapterLeft extends BaseAdapter {
	...
	static private final Logger logger = LoggerFactory
			.getLogger(GridListRowItemsAdapterLeft.class);

	public GridListRowItemsAdapterLeft(Context context, ArrayList<BottleDetails> results) {
