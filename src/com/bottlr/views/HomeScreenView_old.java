...
public class HomeScreenView_old extends Activity {
	...
	private void initGUI() {
		...
		login_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(HomeScreenView_old.this, LoginView.class);
...
//		BottleDetailsView.CURRENT_OPEN_BOTTLE = bottle;
		Intent intent = new Intent(HomeScreenView_old.this, BottleDetailsView.class);
		intent.setFlags(Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY);
		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
