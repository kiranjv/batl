...
public class HomeScreenGridView extends Activity {

	static private final Logger logger = LoggerFactory
			.getLogger(HomeScreenGridView.class);

	private int prev_selected_position = -1;
	private static final String TAG = "HomeScreenView";
	public GridView gridview_bottles;
	private GridListRowItemsAdapter listview_adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.homescreengrid_layout);
		// show The Image
...
//		login_button.setEnabled(false);
	...
	protected void onStart() {
				...
				public void run() {
					...
					runOnUiThread(new Runnable() {
						...
						public void run() {
							...
							gridview_bottles.refreshDrawableState();
						}
					});
		...
		bottle_details_list = BottlesStoreManager.getStoreInstance(context)
			...
			gridview_bottles = (GridView) findViewById(R.id.gridView1);
			
			
			// list_bottles.setAdapter(new ItemListBaseAdapter(this,
			// bottle_details));
			listview_adapter = new GridListRowItemsAdapter(this,
					bottle_details_list);
			gridview_bottles.setAdapter(listview_adapter);
			gridview_bottles.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> a, View v, int position,
					...
					Object o = gridview_bottles.getItemAtPosition(position);
...
//							Toast.LENGTH_SHORT).show();
					...
					Intent intent = new Intent(HomeScreenGridView.this,
			...
			gridview_bottles.setOnScrollListener(new OnScrollListener() {
			...
			gridview_bottles.smoothScrollToPosition(prev_selected_position);
...
//				Toast.LENGTH_SHORT).show();
		...
		Intent intent = new Intent(HomeScreenGridView.this, BottleDetailsView.class);
		intent.setFlags(Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY);
		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
...
//				Toast.LENGTH_SHORT).show();
	...
	class AsyncOldBottleDownload extends AsyncTask<Void, Void, Boolean> {
		...
		private GridListRowItemsAdapter adaptor;
		List<BottleDetails> parsedBottles;
		private String failureMSG;
        private int counter = 1;
		public AsyncOldBottleDownload(int lastIndex,
				GridListRowItemsAdapter adaptor, int bottle_count) {
...
//			String url = URLs.USER_OLD_BOTTLE_URL + bottle_count;
	...
	class AsyncLatestBottleDownload extends AsyncTask<Void, Void, Boolean> {
		...
		public AsyncLatestBottleDownload(GridListRowItemsAdapter adaptor,
				int bottle_count) {
